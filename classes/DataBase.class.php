...
class DataBase{
   ...
   public function __destruct( ){
	...
	public function executeOperation($Query_String){
		$Query_ID = mysql_query($Query_String) or die("Error: " . mysql_error());
		if(!$Query_ID){
			return false;
		}else{
			return true;
	...
	public function executeGrab($Query_String){
		$Resource = mysql_query($Query_String) or die("Error: " . mysql_error());
		if(!$Resource){
			return false;
		}else{
	...
	/*========================================================================================
								Close current MySql DB connection
	==========================================================================================*/
	public function closeDBOnly(){
		 mysql_close();
	}
	
	/*========================================================================================
								Return NumRows of Record DB affected 
	==========================================================================================*/
